...
[@bs.send]
external getWithConfig : (t, string, config) => Js.Promise.t(response('a, 'b)) =
  "get";
...
[@bs.send]
external deleteWithConfig :
  (t, string, config) => Js.Promise.t(response('a, 'b)) =
  "delete";

[@bs.send] external post : (t, string) => Js.Promise.t(response('a, 'b)) = "";

[@bs.send]
external postWithConfig : (t, string, config) => Js.Promise.t(response('a, 'b)) =
  "post";
...
[@bs.send]
external putWithConfig : (t, string, config) => Js.Promise.t(response('a, 'b)) =
  "put";
